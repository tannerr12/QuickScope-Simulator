...
DebugPrint( '[BAREBONES] OnEntityHurt Called' )
...
--if herokiller:IsRealHero() then
  --  herokiller:SetBaseStrength(herokiller:GetBaseStrength()  + 1)
  --  herokiller:SetBaseIntellect(herokiller:GetBaseIntellect()  + 1)
  --  herokiller:SetBaseAgility(herokiller:GetBaseAgility()  + 1)
